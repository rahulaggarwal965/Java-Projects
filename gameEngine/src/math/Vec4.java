...
public class Vec4 extends Vec3 {
	...
	public static Vec4 random(float f) {
		return new Vec4(Maths.randomBilateral(f), Maths.randomBilateral(f), Maths.randomBilateral(f), Maths.randomBilateral(f));
	}
	
	public static Vec4 random(float x, float y, float z, float w) {
		return new Vec4(Maths.randomBilateral(x), Maths.randomBilateral(y), Maths.randomBilateral(z), Maths.randomBilateral(w));
	}
}
