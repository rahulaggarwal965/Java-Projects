...
public class RaymarchingTests implements IGameLogic {
	...
	public void input() {
		// TODO Auto-generated method stub
		Vec2 m = new Vec2(GameEngine.mouse.mouseX, GameEngine.mouse.mouseY);
	...
	public void update(float interval) {
		...
		this.transformedLightPosition = Mat3.rotationY(lightVelocityY)._multiply(this.lightPosition)._add(new Vec3(0, 0, 2));
